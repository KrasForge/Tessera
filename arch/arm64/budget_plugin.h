...
/* Invoke on the plugin instance's owning worker. The banked virtual
 * timer is separate from the physical cadence timer.  Output is unpublished scratch until OK;
